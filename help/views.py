...
Helpbot / ask: `drp ask "question"` asks the drp assistant from the CLI. `drp ask --clear` clears chat history. Chat history is synced between the CLI and the web chat widget — messages appear in both places.
