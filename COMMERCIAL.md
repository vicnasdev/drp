# drp Commercial Self-Hosted License

## LICENSE AGREEMENT

This Commercial Self-Hosted License Agreement ("Agreement") is entered into between **Victorio Nascimento, operating as drp** ("Licensor") and the purchasing organization ("Licensee").
...
- All fees in USD (or local currency equivalent)
...
- Licensor makes no warranty that drp will be error-free or uninterrupted
- Security and reliability depend on Licensee's infrastructure and configuration
...
By purchasing this Commercial Self-Hosted License through Lemon Squeezy, Licensee acknowledges:
- They have read and understand this Agreement
- They agree to all terms and conditions
- They accept all disclaimers and limitations of liability
- They understand the difference between this commercial license and the open-source license

**License Details:**

**Licensee Name:** _________________________________

**License Key/ID:** _________________________________ (provided at purchase)
