...
def _build_license_pdf(lic: CommercialLicense, licensee_name: str) -> bytes:
    ...
    story.append(Paragraph("drp.vicnas.me — clipboard &amp; file sharing", subtitle_style))
    ...
    story.append(Paragraph(
        "This document was generated by drp.vicnas.me and constitutes the full license agreement. "
        "For questions: licensing@drp.vicnas.me",
        footer_style,
    ))
    story.append(Paragraph(
...
def _get_license_sections():
    ...
    return [
        ...
        ("11. General Provisions", [
            ...
            "**Contact:** For license inquiries, support issues, or disputes, contact: licensing@drp.vicnas.me",
        ]),
    ]
